...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('Failed to add thread. The required properties are missing.'),
  ...
  'GET_COMMENTS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('The required properties are missing.'),
  'GET_COMMENTS.NOT_MEET_DATA_TYPE_SPESIFICATION': new InvariantError('The type data of the property does not match.'),
  ...
  'GET_REPLIES.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('The required properties are missing.'),
  'GET_REPLIES.NOT_MEET_DATA_TYPE_SPESIFICATION': new InvariantError('The type data of the property does not match.'),
};
